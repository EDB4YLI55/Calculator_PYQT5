...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.button_clear.clicked.connect(lambda x: self.label.setText("0"))
        ...
        self.button_division.clicked.connect(self.division_toggle)
        ...
        self.button_multiplication.clicked.connect(self.multiplication_toggle)
        ...
        self.button_subtraction.clicked.connect(self.subtraction_toggle)
        ...
        self.button_addition.clicked.connect(self.addition_toggle)
        ...
        self.button_zero.clicked.connect(lambda x: self.numbers(self.button_zero))
        self.button_one.clicked.connect(lambda x: self.numbers(self.button_one))
        self.button_two.clicked.connect(lambda x: self.numbers(self.button_two))
        self.button_three.clicked.connect(lambda x: self.numbers(self.button_three))
        self.button_four.clicked.connect(lambda x: self.numbers(self.button_four))
        self.button_five.clicked.connect(lambda x: self.numbers(self.button_five))
        self.button_six.clicked.connect(lambda x: self.numbers(self.button_six))
        self.button_seven.clicked.connect(lambda x: self.numbers(self.button_seven))
        self.button_eight.clicked.connect(lambda x: self.numbers(self.button_eight))
        self.button_nine.clicked.connect(lambda x: self.numbers(self.button_nine))
    ...
    def numbers(self, *args):
        curr_value = self.label.text()
        if curr_value == "0":
            curr_value = ""
        self.label.setText(curr_value + args[0].text())
    
    def addition_toggle(self):
        self.first_value = self.label.text()
        self.label.setText("")
        self.addition = True
    
    def subtraction_toggle(self):
        self.first_value = self.label.text()
        self.label.setText("")
        self.subtraction = True
    
    def multiplication_toggle(self):
        self.first_value = self.label.text()
        self.label.setText("")
        self.multiplication = True
    
    def division_toggle(self):
        self.first_value = self.label.text()
        self.label.setText("")
        self.division = True
    ...
    def equals(self):
        if self.addition == True:
            self.label.setText(str(int(self.first_value) + int(self.label.text())))
